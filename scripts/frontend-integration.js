 ...
 * This file demonstrates how to integrate Emberchain with a web frontend
 */

// For React/Vue/Angular applications
export class EmberchainClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EmberchainClient(provider, contractAddress);
